...
16. **Transition to Design** — invoke `long-task:long-task-design`

**Terminal state: invoking long-task-design.**
...
**Called by:** using-long-task (when no SRS doc, no design doc, and no feature-list.json — single-repo only)
