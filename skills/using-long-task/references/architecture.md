...
> Authoritative workflow definition: `skills/long-task-work/SKILL.md`. Cycle: Orient → Feature Design → TDD Red → TDD Green → TDD Refactor → Persist → End Session. One feature per cycle; external `scripts/auto_loop.py` handles multi-feature automation.
