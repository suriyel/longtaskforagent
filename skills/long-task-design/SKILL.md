...
- **按需省略规则**：L2/L3 纯规约式增量场景，§1 / §2 / §3.1-§3.4 / §5 / §6.1 / §7 / §8 / §10 等可整节标 `[不适用]` + 附一句理由；§6.2 以 6.2.1 / 6.2.2 子表表达即可；**§6.2 / §11 永不可省**
...
| "L2 输入也要硬填 §1 / §2 / §3 架构概览 / §5 / §6.1 / §7 / §8 / §10" | 这些章节在规约式增量场景下是空洞填充。整节标 `[不适用]` + 附一句理由，不硬凑内容。**§6.2 / §11 永不可省。** |
