...
# Feature-ST — Black-Box Acceptance Testing

Execute black-box acceptance testing for the feature. Read all documents yourself.
...
Report summary using Structured Return Contract from `feature-st-execution.md`.
...
**Called by:** long-task-work (Step 7) — Worker dispatches SubAgent, SubAgent loads this Skill and executes inline
