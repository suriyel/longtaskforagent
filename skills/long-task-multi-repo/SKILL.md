...
12. **Granularity analysis** — bidirectional sizing (G1-G6 split, S1-S4 group)
...
- L5 = Steps 11–13 + Step 15 (validate, granularity, deferral, SRS reviewer with Group P = PASS-SKIPPED)
...
Same as shared Steps 9–13 in the checklist. No differences from standard process.
